  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 rounded-xl border border-line bg-surface p-6">
        ...
        <div>
          <h2 className="text-xl font-semibold tracking-tight text-fg">{player.playerName}</h2>
        ...
        <div className="flex flex-wrap items-end gap-6">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="none"
              className="w-24 rounded-lg border border-line bg-elevated px-3 py-2 text-center text-[14px] text-fg focus:border-accent focus:outline-none"
            />
          </div>
          <div className="space-y-1.5">
